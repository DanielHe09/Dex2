...
- **Empty horizontal TEXT_BOX in white space** (e.g. below the slide title, above a row of columns): do NOT use a tiny height (no thin strips). **width_pt** should span most of the slide content area (≈ page width − 72pt margins). **height_pt** must be at least **72pt**, preferably **80–120pt**, or **~70–85% of the vertical FREE SPACE gap** you are filling (read GAP y-ranges and max height). A box under 48pt tall is wrong for “empty text box in whitespace.”
